...
?>
<div class="wrap aicc-wrap" style="max-width: 1000px;">
	<h1 class="wp-heading-inline">
		<span class="dashicons dashicons-layout aicc-heading-icon"></span>
		<?php esc_html_e( 'Blog Style Examples', 'ai-content-orchestrator' ); ?>
	</h1>
...
jQuery(document).ready(function($) {
	$('.aicc-example-toggle').on('click', function() {

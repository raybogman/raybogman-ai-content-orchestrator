...
class AICC_Instagram {
	...
	public static function get_auth_url() {
		...
		$redirect_uri = admin_url( 'admin.php?page=aicc-settings&tab=instagram' );

		$state = wp_create_nonce( 'aicc_instagram_oauth' );
		set_transient( 'aicc_instagram_oauth_state', $state, 600 );
	...
	public static function handle_callback( $code, $state ) {
		...
		update_option( 'aicc_instagram_tokens', array(
			'access_token' => $short_token,
			'expires_at'   => $expires_at,
		) );

		update_option( 'aicc_instagram_profile', array(
	...
	public static function share_post( $post_id ) {
		...
		$caption = get_post_meta( $post_id, '_aicc_instagram_caption', true );
		if ( empty( $caption ) ) {
		...
		// Mark as shared.
		update_post_meta( $post_id, '_aicc_instagram_shared', time() );
		update_post_meta( $post_id, '_aicc_instagram_media_id', $publish['id'] );
		delete_post_meta( $post_id, '_aicc_instagram_error' );
	...
	public static function get_profile() {
		return get_option( 'aicc_instagram_profile', array() );
	}
	...
	public static function disconnect() {
		delete_option( 'aicc_instagram_tokens' );
		delete_option( 'aicc_instagram_profile' );
	}
	...
	public static function get_client_id() {
		return get_option( 'aicc_instagram_app_id', '' );
	}
	...
	public static function get_client_secret() {
		return get_option( 'aicc_instagram_app_secret', '' );
	}
}
